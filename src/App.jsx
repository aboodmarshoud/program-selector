...
function ProgramMini({ program, index, onOpen }) {
  return (
    <button className="mini-program" onClick={() => onOpen(program.id)} type="button">
      ...
      <span className="mini-score">{Math.min(99, Math.round(program.score))}%</span>
    </button>
  );
}
      ...
      <main className="app-shell">
        <section className="hero-card">
          ...
          <div className="hero-content">
            <div className="eyebrow">Scorecard لاختيار البرنامج الأنسب</div>
            <h1>لا تختر البرنامج بالاسم… اختره بحسب حاجتك ومرحلتك.</h1>
            <p>
              أسئلة قصيرة بصياغة غير مباشرة تقيس العمر، البيئة المناسبة، نمط الالتزام، وهدف التعلم، ثم تعرض توصية مفسّرة مع بدائل قريبة.
            </p>
            <div className="hero-pills">
              <Pill>كل البرامج: مجاني</Pill>
              <Pill>الوسيلة: موقع البرنامج + تلجرام</Pill>
              <Pill>أسئلة يومية لا أسبوعية</Pill>
            </div>
          </div>
        </section>

        {!showResult && !openedProgram && current && (
        ...
        {showResult && !openedProgram && primary && (
          <section className="result-wrap">
            <div className="result-main" style={{ borderColor: `${primary.color}55` }}>
              <div className="result-top" style={{ background: `linear-gradient(135deg, ${primary.soft}, #ffffff)` }}>
                ...
                <div>
                  <div className="result-label">التوصية الأقرب حسب Scorecard</div>
              ...
              <div className="result-body">
                <div className="detail-grid">
                  ...
                  <div><small>درجة الملاءمة</small><strong>{Math.min(99, Math.round(primary.score))}%</strong></div>
                </div>
            ...
            <div className="side-card">
              ...
              {recommendations.slice(1, 5).map((p, i) => (
                <ProgramMini key={p.id} program={p} index={i + 1} onOpen={setOpenedProgramId} />
              ))}
        ...
        {openedProgram && (
          <section className="program-page">
            <button className="ghost-btn back-program" type="button" onClick={() => setOpenedProgramId(null)}>العودة للنتيجة</button>
...
.mini-score { background: var(--teal-soft); color: #0b604f; padding: 5px 8px; border-radius: 999px; font-size: 12px; font-weight: 900; }
