...
export const QUESTIONS = [
  ...
  {
    id: "quranHifz",
    title: "هل أتممت حفظ القرآن الكريم؟",
    subtitle: "نسأل لأن برنامج عالِم يشترط حفظ القرآن كاملًا ويُختبر فيه؛ فلا نُقدّمه لمن لم يستوفِ الشرط.",
    condition: (a) => isAgeAtLeast15(a) && a.dailyTime === "formation_project",
    options: () => [
      option("full", "نعم، أتممت حفظه كاملًا وأتقنته", "مستوفٍ لشرط برنامج عالِم", ""),
      option("most", "حفظت أكثره أو قريب جدًا من الختم", "قريب من الشرط؛ راجع شروط الدفعة عند الإعلان", ""),
      option("partial_or_none", "دون ذلك أو لم أكمل الحفظ بعد", "نوجّهك لما يناسب مرحلتك بدل عالِم", ""),
    ],
  },
  {
    id: "needClarity",
