export const PROGRAMS = {
  ...
  buthur: {
    ...
    goals: [
      "غرس الإيمان والقيم بأسلوب شيق يناسب الطفل.",
      "بناء بدايات أخلاقية ومهارية تعين على الجد والوقار وحسن السلوك.",
      "تعليم أساسيات الدين الشرعية بأسلوب مبسط مناسب للسن."
    ],
    outcomes: [
      "محبة الدين والتعلق بالنبي والصحابة.",
      "بدايات خلقية وسلوكية قوية.",
      "ارتباط مبكر ببيئة نافعة تنمي وعيه الثقافي.",
  ...
  juthur: {
    ...
    goals: [
      "بناء إيماني عميق يعالج احتياجات المرحلة المتأخرة بلغة تناسب اليافعين.",
      "تأسيس منهجي وفكري متين يساعد الطالب على التفكير والنظر والوعي المبكر.",
      "توفير بيئة متابعة قريبة وبناء سلوكي وتزكوي مناسب للمرحلة."
    ],
    outcomes: [
      "بيئة صحبة صالحة وانضباط تربوي مستمر.",
      "فهم للأساسيات الشرعية وتاريخ العهد المكي والمدني بصورة تناسب اليافعين.",
  ...
  ghiras: {
    ...
    goals: [
      "توفير بيئة تربوية عامة تجمع بين الإيمان والوعي والتأصيل المناسب للعمر.",
      "تأسيس الوعي المنهجي بصورة مناسبة لهذه المرحلة دون ضغط انتقائي عال.",
      "تخفيف عائق الانتقائية لمن يحتاج بداية أيسر مع تأصيل ممتاز."
    ],
    outcomes: [
      "ارتباط ببيئة نافعة بعيدًا عن ضغط الاختبارات الصارمة.",
      "بناء سلوكي للسن المراهق.",
  ...
  ishraq: {
    ...
    goals: [
      "تحصين الشباب في مرحلة الجامعة ببناء إيماني وعلمي مناسب لبدايات النضج.",
      "بناء وعي فكري ومنهجي قوي يجمع بين التأصيل والمهارات.",
      "توفير بيئة صحبة ومتابعة تعين على تأسيس المصلح وتهذيب مشروعه."
    ],
    outcomes: [
      "ثبات أكبر عبر بيئة تزكوية تفاعلية.",
      "وعي بالتاريخ ومصادر التلقي والشبهات لفهم الواقع المستجد.",
      "إلمام شرعي بالأساسيات بصورة تناسب مرحلة الشباب.",
  ...
  ithmar: {
    ...
    icon: "",
    duration: "4 سنوات",
    audience: "خريجو جذور أو إشراق، بحسب إعلان الدفعة",
    cost: "مجاني",
    medium: "موقع البرنامج + تلجرام",
    officialUrl: "https://jeelacademy.app/",
    telegramUrl: "https://t.me/JeelAcademySA",
    ...
    goals: [
      "الانتقال لخريجي الأكاديمية نحو التخصص الدقيق في أبواب علمية وفكرية أعمق.",
    ...
    outcomes: [
      "تخصص شرعي أو فكري رصين.",
      "نضج منهجي ومهاري للعمل الدعوي والإصلاحي.",
      "استمرار البناء التزكوي والإيماني.",
      "انتقال خريجي جذور وإشراق من البناء العام إلى تخصصات دقيقة بإشراف أعلى."
    ],
    suitable: ["تخرجت من جذور أو إشراق أو أنت على وشك التخرج منهما.", "تنطبق عليك شروط الدفعة المعلنة في أكاديمية الجيل الصاعد.", "تريد التخصص لا مجرد البناء العام."],
